# 📋 Quick Reference: Bash Reserved Keywords, Operators & Special Variables

This guide provides an easy-to-read reference table covering the core keywords, constructs, and built-in variables essential for writing Bash scripts.

---

## The Master Reference Table

| # | Keyword / Construct | Description |
| :---: | :--- | :--- |
