# 📋 Quick Reference: Bash System-Defined Variables

This reference guide provides an organized table layout of the built-in environment and system variables maintained automatically by the Bash shell.

---

## System Variables Reference Table
